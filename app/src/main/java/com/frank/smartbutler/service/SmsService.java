package com.frank.smartbutler.service;
...
import com.frank.smartbutler.view.DispatchLinearLayout;

/**
 * 文件名:SmsService
 * 项目名:smartbutler
 * 包名:com.frank.smartbutler.service
 * 创建者:Frank
 * 创建时间:2018/3/14 16:25
 * 描述:      短信监听服务
 */
public class SmsService extends Service implements View.OnClickListener {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (StaticClass.SMS_ACTION.equals(action)) {
                ...
                for (Object obj : objs) {
                    ...
                    LogUtils.i(this, "短信的内容：" + smsPhone + ":" + smsContent);
                    showWindow();
                }
            }
        }
    ...
    private void showWindow() {
        ...
        LogUtils.i(this, "短信内容：" + smsContent);
