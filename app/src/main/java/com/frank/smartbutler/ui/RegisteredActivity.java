            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(name) & !TextUtils.isEmpty(age) &
                    ...
                    if (pass.equals(password)) {
                        ...
                        Toast.makeText(getApplicationContext(), R.string.text_two_input_not_consistent, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(getApplicationContext(), getString(R.string.text_tost_empty), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
